...
export class HMACSigner {
  ...
  public getOpts = (url: string, payload?: string) => {
    ...
    if (payload !== undefined && payload != '') return { body: payload, headers: zestHeaders };
    else return { headers: zestHeaders };
  };
}

export class AppscapeServiceApiHMAC extends AppscapeServiceApi {
